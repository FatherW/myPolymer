...
app.directive('dazzleFormSelectElement', function ($compile, $templateRequest, $mdDialog, $uibModal) {
    var dazzleFormSelectElement = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "dazzleFormSelectElement";
            scope.type = "dazzleFormSelectElement";
        ...
        controller: function ($scope, $element, $attrs) {
            $scope.menuOptions = [
                ["dazzleFormSelectElement", function () {
                    console.log("Menu Clicked:dazzleFormSelectElement");
                }]/*,
                 ["更換模版", function () {
                 $mdDialog.show({
    ...
    return dazzleFormSelectElement;
});