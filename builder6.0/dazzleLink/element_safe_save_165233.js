...
app.directive('dazzleLink', function ($compile) {
    var dazzleLink = {
        ...
        controller: function ($scope, $element, $attrs, $mdDialog) {
            console.log($element.closest('[context-menu]').length < 1, angular.isUndefined($element.attr('context-menu')), $element);
            console.log($element.closest('[context-menu]').length, $element.closest('[context-menu]'));
