...
app.directive(name, function ($compile, $templateRequest, $mdDialog, $uibModal,$dazzleUser,$dazzleS3,$dazzlePopup,$dazzleFn,$dazzleInit,$dazzleData,pageInfo,userInfo,dzS3) {
    var link = {
        restrict: 'E',
        scope: true,
...
//        templateUrl: "https://d25k6mzsu7mq5l.cloudfront.net/builder6.0/pageInfoManagerPopup/element.html?id=" + new Date().getTime(),
     ...
     //           }
            ...
            $scope.save = function () {
                ...
                pageInfo.saveInfo().then(function(){
