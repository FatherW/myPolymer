var app = angular.module('demoApp');
    app.directive('adminDetail', function($compile, $timeout,$mdDialog, $mdToast, $dazzleS3,  $dazzleUser, $dazzlePopup) {
      ...
      var adminDashboard = {
        ...
        priority: 1000,
        scope: true,
        templateUrl: "https://d27btag9kamoke.cloudfront.net/builder6.0/adminDetail/element.html?id=" + new Date().getTime(),
