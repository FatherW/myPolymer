    ...
    var dazzleForm3 = {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.editorCustomInit(scope, element, attrs).then(function () {
            	...
            	if(scope.thisPageJson.js.indexOf('http://d27btag9kamoke.cloudfront.net/file6.0/dazzleForm3.js')<0){
            		scope.thisPageJson.js.push('http://d27btag9kamoke.cloudfront.net/file6.0/dazzleForm3.js');
            	}
                if(scope.thisPageJson.js.indexOf('http://d27btag9kamoke.cloudfront.net/cdn6.0/js/aws-sdk-2.169.0.min.js')<0){
            		scope.thisPageJson.js.push('http://d27btag9kamoke.cloudfront.net/file6.0/dazzleForm3.js');
            	}
