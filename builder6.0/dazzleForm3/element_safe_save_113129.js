    ...
    var dazzleForm3 = {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.editorCustomInit(scope, element, attrs).then(function () {
            	...
            	if(scope.thisPageJson.js.indexOf('http://d27btag9kamoke.cloudfront.net/file/dazzleForm.js')==-1){
            		scope.thisPageJson.js.push('http://d27btag9kamoke.cloudfront.net/file/dazzleForm.js');
            	}
            ...
            $scope.menuOptions = [
                ...
                ["編輯表格及資料", function () {
                      $mdDialog.show({
                            ...
                            }).then(function(receiveemail){
                            	$scope.model.receiveemail=receiveemail;
                            	$scope.receiveemail=receiveemail;
