...
app.directive('dazzleTrans', function($compile, $templateRequest, $mdDialog, $uibModal){
      return {
        restrict: 'E',
        transclude: true,
        scope: true,
        template: '<div context-menu="menuOptions" style="border: 1px solid black;">' +
                ...
                ["新增結構", function () {
                    $mdDialog.show({
                        ...
                        for (var i = 0; i < structure.length; i++) {
                            html.append("<div class='col col-md-" + structure[i] + "'><dazzle-trans></dazzle-trans></div>")
                        }
