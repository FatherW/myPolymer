...
app.directive('dazzleEmailImage', function ($compile, $templateRequest, $http, $uibModal) {
    var dazzleEmailImage = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "dazzleEmailImage";
            scope.type = "dazzleEmailImage";
