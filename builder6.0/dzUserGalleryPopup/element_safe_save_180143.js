...
var name = 'dzUserGalleryPopup';

app.directive(name, function ($compile, $templateRequest, $mdDialog, $uibModal,$dazzleUser,$dazzleS3,$dazzlePopup,$dazzleFn) {
    var link = {
        restrict: 'E',
        scope: true,
        templateUrl: "https://d27btag9kamoke.cloudfront.net/builder6.0/dzUserGalleryPopup/element.html?id=" + new Date().getTime(),
...
//                    $mdDialog.hide(element);
                ...
                $scope.saveTag = function(element,index) {
