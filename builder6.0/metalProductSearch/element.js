...
app.directive('metalProductSearch', function ($http,$route, $compile, $templateRequest, $interval, $mdDialog,  $dazzleUser, $dazzleInit, $dazzleS3, $dazzlePopup, $ocLazyLoad) {
    var name = 'metalProductSearch';
    var link = {
        restrict: 'E',
        scope: true,
