...
app.directive('editorImageElement2', function ($compile, $templateRequest, $http, $mdDialog,$dazzleUser,$dazzleInit,$dazzlePopup,$dazzleData) {
    var editorImageElement2 = {
        restrict: 'EA',
        priority: 1000,
        scope: true,
//        templateUrl: "https://d25k6mzsu7mq5l.cloudfront.net/file6.0/directive-template.html",
        link: function (scope, element, attrs) {
            ...
            scope.directiveId = "editorImageElement2";
            scope.type = "editorImageElement2";
