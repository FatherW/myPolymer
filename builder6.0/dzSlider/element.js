...
app.directive('dzSlider', function ($compile, $templateRequest, $mdDialog, $dazzlePopup,dzFn,atomInfo) {
    var dzSlider = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        ...
        css: {
          href: "//d27btag9kamoke.cloudfront.net/builder6.0/dzSlider/element.css?id=" + new Date().getTime(),
