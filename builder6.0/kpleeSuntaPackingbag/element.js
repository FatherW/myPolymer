...
app.directive('kpleeSuntaPackingbag', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaPackingbag = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "kpleeSuntaPackingbag";
            scope.type = "kpleeSuntaPackingbag";
