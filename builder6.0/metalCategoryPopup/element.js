...
app.directive('metalCategoryPopup', function ($compile, $templateRequest, $mdDialog, $dazzlePopup) {
    var name = 'metalCategoryPopup';
    var link = {
        restrict: 'E',
        scope: true,
        templateUrl: "https://d27btag9kamoke.cloudfront.net/builder6.0/metalCategoryPopup/element.html?id=" + new Date().getTime(),
        link: function (scope, element, attrs) {
            scope.http = "https://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "metalCategoryPopup";
            scope.type = "metalCategoryPopup";
