...
app.directive('dzFilePopup', function ($compile, $templateRequest, $mdDialog, $dazzlePopup,$dazzleFn,$dazzleInit,dzFn) {
    var name = 'dzFilePopup';
    var link = {
        restrict: 'E',
        scope: true,
        templateUrl: "//d27btag9kamoke.cloudfront.net/builder6.0/dzFilePopup/element.html?id=" + new Date().getTime(),
        link: function (scope, element, attrs) {
            scope.http = "//d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "dzFilePopup";
            scope.type = "dzFilePopup";
                ...
                $scope.upload = function () {
                    ...
                    $dazzlePopup.callPopup(params).then(function(output){
                        angular.forEach(output,function(item,index){
                           ...
                           $scope.images.push(dzFn.getFileUrl('large-web',item.gid)); 
                        });
                    });
