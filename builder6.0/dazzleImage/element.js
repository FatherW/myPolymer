...
app.directive('dazzleImage', function ($compile, $templateRequest, $http, $mdDialog,$dazzleUser,$dazzleS3,$dazzleInit,$dazzlePopup,$dazzleData,$dazzleFn) {
   var template = angular.element('<div class="dazzle-screen"></div><div bind-html-compile="model.html" context-menu="menuOptions"></div>');
    var dazzleImage = {
        restrict: 'EA',
        priority: 1000,
        scope: true,
