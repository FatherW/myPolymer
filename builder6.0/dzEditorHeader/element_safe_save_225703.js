...
// (function( $ ) {
//   $(function() {
        app.directive('dzEditorHeader', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData,$dazzleFn, $dazzleUser, $dazzlePopup,$dazzleInit,$dazzleElastic,hotkeys){
            ...
            var dzEditorHeader = {
                ...
                priority: 1000,
                scope: true,
                templateUrl: "http://d27btag9kamoke.cloudfront.net/builder6.0/dzEditorHeader/element.html?id=" + new Date().getTime(),
...
//                            $dazzleUser.dazzleInfo['bodyHtml'] = html;                            
                    ...
                    */
                    ...
                    $scope.export = function () {
                        ...
                        //     var params = {
                        //       name : 'dzExportPopup2',
                        //       directive: '<dz-export-popup2></dz-export-popup2>'
                        //     };
                        //     $dazzlePopup.callPopup(params).then(function(result){
