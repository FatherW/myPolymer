...
// (function( $ ) {
//   $(function() {
        app.directive('dzEditorHeader', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData,$dazzleFn, $dazzleUser, $dazzlePopup,$dazzleInit,$dazzleElastic,hotkeys,pageInfo,dzFn){
            var dzEditorHeader = {
                restrict: 'E',
                priority: 1000,
                scope: true,
