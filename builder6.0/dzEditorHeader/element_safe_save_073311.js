...
// (function( $ ) {
//   $(function() {
        app.directive('dzEditorHeader', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData,$dazzleFn, $dazzleUser, $dazzlePopup,$dazzleInit,$dazzleElastic,hotkeys,pageInfo,dzFn,dzS3){
            var dzEditorHeader = {
                restrict: 'E',
                priority: 1000,
                scope: true,
	...
	$dazzleElastic.getUserElasticTables = function() {
        ...
        //                 });
                    ...
                    $scope.dataManager = function() {
                        ...
                        // var tableList = $dazzleUser.dazzleInfo['tableList'];
