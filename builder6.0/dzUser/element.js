...
app.directive('dzUser', function ($compile, $mdDialog,$dazzlePopup,$dazzleUser,$http,$dazzleElastic) {
    var dzUser = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        templateUrl: "https://d27btag9kamoke.cloudfront.net/builder6.0/dzUser/element.html?id=" + new Date().getTime(),
