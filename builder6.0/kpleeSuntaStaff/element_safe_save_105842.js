...
app.directive('kpleeSuntaStaff', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaStaff = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            ...
            scope.directiveId = "kpleeSuntaStaff";
            scope.type = "kpleeSuntaStaff";
