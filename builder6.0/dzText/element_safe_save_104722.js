...
//                                    $('.medium-editor-toolbar').css('visibility','visible');
                ...
                controller: function ($scope, $element, $attrs, $transclude, $mdDialog, $dazzlePopup,$dazzleInit,$dazzleS3) {
                    $ocLazyLoad.load(["//cdn.jsdelivr.net/npm/medium-editor@latest/dist/js/medium-editor.min.js","//cdn.jsdelivr.net/npm/medium-editor@latest/dist/css/medium-editor.min.css"], {cache: false}).then(function(){
