...
//var MediumEditor=require(['https://d27btag9kamoke.cloudfront.net/cdn6.0/js/medium-editor-5.23.1.min.js']);
...
//                transclude: true,
                css: {
                  href: "//d27btag9kamoke.cloudfront.net/builder6.0/dzText/element.css?id=" + new Date().getTime(),
...
//                            $dazzlePopup.linkPopup($element, oldlink).then(function (result) {
    ...
    //                                        console.log(html.html());
                    ...
                    var youtubeButton = MediumEditor.Extension.extend({
                        name: 'youtubeButton',
                        init: function () {
                            this.button = this.document.createElement('button');
                            this.button.classList.add('medium-editor-action');
                        ...
                        handleClick: function (event) {
                             var html = "<dz-youtube></dz-youtube>";
                    ...
                    var ImageElementButton = MediumEditor.Extension.extend({
                     ...
                     var structureElementButton = MediumEditor.Extension.extend({
                        name: 'structureElementButton',
                        init: function () {
                            this.button = this.document.createElement('button');
                            this.button.classList.add('medium-editor-action');
                            this.button.innerHTML = '<i class="fa fa-grip-horizontal"></i>';
                            this.on(this.button, 'click', this.handleClick.bind(this));
                        },
                        getButton: function () {
                            return this.button;
                        ...
                        handleClick: function (event) {
                            var params = {
                              'name':"dzLayoutPopup",
                              "directive":"<dz-layout-popup></dz-layout-popup>"
                            };
                            $dazzlePopup.callPopup(params).then(function(result){
                                var html = "<img dz-image src='http://dazzle.website/image/lgo.png' context-menu='menuOptions'/>";
                                $scope.editor.events.base.pasteHTML(html);
                    ...
                    $scope.editor = new MediumEditor($element, {
                        ...
                        toolbar: {
                            buttons: ['youtubeButton', 'anchorButton', 'imageElementButton','structureElementButton',  'fontsize', 'bold', 'italic', 'underline', 'orderedList', 'unorderList', 'justifyLeft', 'justifyRight', 'justifyCenter', 'justifyFull', 'removeFormat', 'h1', 'h2', 'h3', 'p'],
                            static: true,
                            sticky: true,
                        ...
                        extensions: {
                            ...
                            'structureElementButton':new structureElementButton()
