...
var name = 'dzHtmlPopup';
app.directive(name, function ($compile, $templateRequest, $mdDialog, $uibModal,$dazzleUser,$dazzleS3,$dazzlePopup) {
    var link = {
        restrict: 'E',
        scope: true,
        templateUrl: "//d27btag9kamoke.cloudfront.net/builder6.0/dzHtmlPopup/element.html?id=" + new Date().getTime(),
        ...
        controller: function ($scope, $element,$mdDialog, $templateRequest, $http,$dazzleS3,$compile,$dazzleUser,$dazzleInit,$dazzleData) {
                ...
                var html = params.html;
                   ...
                   console.log('editdzHtmlPopupController');
...
//                            $dazzleInit.loadAtomInfo().then(function(result){
                               ...
                               $dazzleInit.loadDirective('dzText');
                              $dazzleInit.loadDirective('dzImage');

								$dazzleInit.loadDirective('dzEditor');
							   ...
							   for (key in atom){
 							   ...
 							   setTimeout(function(){
                                    ...
                                    // $compile($element.find('text'))($scope);
                                        $compile($element.find('dz-image'))($scope);
