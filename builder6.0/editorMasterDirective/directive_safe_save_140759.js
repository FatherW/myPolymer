    ...
    var master = {
        ...
        controller: function ($scope, $http, $element, $attrs) {
            if (angular.isUndefined($scope.model.masterId) || angular.isUndefined($scope.masterAtom[$scope.model.masterId])) {
                ...
                console.log($scope.model.id, 'use', $scope.model.masterId);
            }
            console.log('my html:', $scope.model.html);
            console.log('master html:', $scope.masterAtom[$scope.model.masterId].html);
