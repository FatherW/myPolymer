...
app.directive('dzOverlay', function ($compile, $templateRequest, $http, $mdDialog,$dazzleUser,$dazzleS3,$dazzleInit,
    $dazzlePopup,$dazzleData,$dazzleFn,panelInfo,atomInfo,dzFn,hotkeys) {
    var dzOverlay = {
        restrict: 'EA',
        priority: 1000,
        scope: true,
        templateUrl: "https://d27btag9kamoke.cloudfront.net/builder6.0/dzOverlay/element.html?id=" + new Date().getTime(),
...
//
//
//                 ["顯示/隱藏子元件", function ($itemScope) {
// 					var ele = angular.element($scope.target);
// 					console.log('Overlay Element',ele);
//                     ele.find("*").show();
//
// 				}],
//
//                 ["連結管理", function ($itemScope) {
//                     var ele=$scope.target;
//                     var newEle;
//                     console.log('Ele',ele);
//                     newEle= dzFn.checkParent(ele,'href');
//
//                     console.log('New Ele',ele);
//
//                     var oldlink = ele.attr('href') || "";
...
//                     }
//
//                     console.log('New Ele',ele,oldlink);
//                     var params = {
//                         name: 'dzLinkPopup',
...
//                 ["啟用／取消資料綁定", function () {
//                     var ele = $scope.target;
//                     var data = ele.attr('dz-data');
//                     if (!angular.isUndefined(data))
//                         ele.removeAttr('dz-data');
//                     else
//                         ele.attr('dz-data','');
//                     $compile(ele)($scope);
//                     $element.remove();
