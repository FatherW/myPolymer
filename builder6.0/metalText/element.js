//var AutoList= require('http:https://d27btag9kamoke.cloudfront.net/cdn6.4/js/app.bundle.js');
//var MediumEditor=require('http:https://d27btag9kamoke.cloudfront.net/cdn6.4/js/app.bundle.js');

var app = angular.module('demoApp');
// jQuery.noConflict();
// (function( $ ) {
//   $(function() {
        app.directive('metalText', function ($compile,$dazzleFn,$dazzleUser,$dazzleInit) {
...
//                                    $('.medium-editor-toolbar').css('visibility','visible');
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.directiveId = "metalText";
                    scope.type = "metalText";
                    ...
                    //             console.log('Metal Text',content);
...
//                                $scope.model.src = $dazzleFn.getFileUrl('large-web',output.gid);
    ...
    //                                        console.log(html.html());
                    ...
                    var ImageElementButton = MediumEditor.Extension.extend({
                        ...
                        handleClick: function (event) {
//                            var html = "<dz-image></dz-image>";
                            var html = '<img src="http://dazzle.gallery/images/logo.png" context-menu="imgMenuOptions">';
