...
app.directive('attrImageElement', function ($compile, $templateRequest, $http, $mdDialog) {
    var attrImageElement = {
        restrict: 'A',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "attrImageElement";
