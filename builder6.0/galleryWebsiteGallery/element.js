...
(function( $ ) {
  $(function() {
        app.directive('galleryWebsiteGallery', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData, $dazzleUser, $dazzlePopup,$dazzleInit) {
            ...
            var galleryWebsiteGallery = {
                restrict: 'E',
                priority: 1000,
                scope: true,
                templateUrl: "//d25k6mzsu7mq5l.cloudfront.net/builder6.0/galleryWebsiteGallery/element.html?id=" + new Date().getTime(),
