...
app.directive('adminFiles', function ($compile, $templateRequest, $mdDialog, $dazzleUser,$dazzleS3,$dazzlePopup,userInfo,dzS3) {
    var name = 'adminFiles';
    ...
    var link = {
        ...
        controller: function ($scope, $element, $attrs,$dazzleS3, $http,$mdSidenav, $mdBottomSheet,$log) {
                ...
                $scope.prefix = "admin/"+userInfo.uid+"/files/";
                $scope.inited = false;
                $scope.userGallery = [];
                $scope.allList = [];
                $scope.tags = [];
...
//                $scope.tags = $scope.tags.push($scope.owner);
                ...
                //             $scope.userGallery = [];
                //             dzS3.listObject(userInfo.exportBucket,$scope.prefix).then(function(files){
...
//                    $mdDialog.hide(element);
                 ...
                 $scope.getFileUrl = function (type) {

                    switch(type){
                        case 'doc':
                        case 'docx':
                            return "https://d27btag9kamoke.cloudfront.net/file6.0/images/word.png";                            
                            break;

                        case 'xls':
                        case 'xlsx':
                            return "https://d27btag9kamoke.cloudfront.net/file6.0/images/excel.png";                            
                            break;

                        case 'ppt':
                        case 'pptx':
                            return "https://d27btag9kamoke.cloudfront.net/file6.0/images/ppt.png";                            
                            break;

                        case 'pdf':
                            return "https://d27btag9kamoke.cloudfront.net/file6.0/images/pdf.png";                            
                            break;
