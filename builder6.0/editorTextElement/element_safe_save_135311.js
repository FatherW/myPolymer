...
app.directive('text', function ($compile) {
    var text = {
        ...
        scope: true,
        transclude: true,
        controller: function ($scope, $element, $attrs, $transclude, $mdDialog) {
...
//			         }
            ...
            var elementButton = MediumEditor.Extension.extend({
                ...
                handleClick: function (event) {
                    //                       $scope.editor.events.base.pasteHTML('<editor-menu-element></editor-menu-element>');
                    //                    $compile($element.contents())($scope);
                    $scope.editor.saveSelection();
            ...
            $scope.beforeAtomSaved = function () {
                ...
                if (!angular.isUndefined($element.attr('field')) && $element.attr('field')) {
                    ...
                    console.log('Before Save', $element.attr('field'));
                }
