                ...
                handleClick: function (event) {
                    ...
                    $scope.linkPopup($element).then(function (result) {
                        ...
                        switch (result.type) {
                            case "setLink":
                                if (result.link == '#') {
                                    var element = angular.element("<div></div>").append($scope.editor.getSelectedParentElement());
                                    element.find("a").forEach(function (index, element) {
                                        console.log(element);
                                    })
                                    console.log('cancel link');
                                    console.log();
                                    console.log($scope.editor.getFocusedElement());
                                } else {
