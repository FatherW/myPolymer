...
app.directive('kpleeSuntaKnowdetail', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaKnowdetail = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "kpleeSuntaKnowdetail";
            scope.type = "kpleeSuntaKnowdetail";
