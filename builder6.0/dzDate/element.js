...
//var _name ="dzDate";
app.directive('dzDate', function ($compile, $templateRequest, $http, $mdDialog,$dazzleUser,$dazzleS3,$dazzleInit,$dazzlePopup,$dazzleData,$dazzleFn,
    atomInfo,userInfo) {
    var dzLink = {
      restrict: 'E',
        priority: 1000,
        ...
        templateUrl: "//d27btag9kamoke.cloudfront.net/builder6.0/dzDate/element.html?id=" + new Date().getTime(),
        css: {
          href: "//d27btag9kamoke.cloudfront.net/builder6.0/dzDate/element.css?id=" + new Date().getTime(),
