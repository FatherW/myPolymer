...
app.directive('skmgpsChat', function ($compile, $templateRequest, $mdDialog, $uibModal,$http) {
    var skmgpsChat = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        templateUrl: "//d25k6mzsu7mq5l.cloudfront.net/builder6.0/skmgpsChat/element.html?id=" + new Date().getTime(),
