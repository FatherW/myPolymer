...
app.directive('dbSettingPopup', function ($compile, $templateRequest, $mdDialog, $dazzlePopup,$dazzleData) {
    ...
    var link = {
        ...
        controller: function ($scope, $element, $attrs,$dazzleS3, $http, $mdDialog, $mdSidenav, $mdBottomSheet,$dazzleUser,$dazzleFn) {
                ...
                $scope.init = function() {
                    ...
                    $dazzleData.loadMyTable("hotyeah").then(function(result){
                       console.log(result);
                ...
                $scope.loadMyField = function() {
                    $dazzleData.loadMyField($currentDataSet.index,$currentDataSet.table).then(function(result){
