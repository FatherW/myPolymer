...
app.directive('editorImageElement', function ($uibModal, $ocLazyLoad) {
    ...
    var editorImageElement = {
        ...
        controller: function ($scope, $element, $attrs, $http) {
            ...
            function copyToExportBucket(key, model, callback) {
                return new Promise(function (resolve, reject) {
                    ...
                    webBucket.copyObject(params, function (err, data) {
                        $scope.$apply(function () {
                            $scope.model.src = 'http://' + website.bucket + '/' + key;
                            resolve();
                        });
                    });
                })
