...
app.directive('kpleeSuntaReport', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaReport = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "kpleeSuntaReport";
            scope.type = "kpleeSuntaReport";
