...
app.directive('newEditorHeader', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData, $dazzleUser, $dazzlePopup,$dazzleInit) {
            // Function save$scope.this$scope.pageJson, save$scope.masterJson, saveRootHtml, saveMasterAtom, save$scope.thisPage
    ...
    var newEditorHeader = {
        ...
        controller: function ($scope, $http, $element) {
            ...
            $scope.init = function() {
                ...
                $scope.this$scope.pageJson = $dazzleUser.getDazzleInfo('this$scope.pageJson');
                $scope.masterJson = $dazzleUser.getDazzleInfo('masterJson');
                $scope.pageJson = $dazzleUser.getDazzleInfo('$scope.pageJson');
            ...
            $scope.pageManager = function() {
                var $scope.pageJson = $dazzleUser.getDazzleInfo('$scope.pageJson');
            ...
            $scope.save$scope.this$scope.pageJson = function () {
                return new Promise(function (resolve, reject) {
                    $dazzleS3.saveJson($scope.userBucket, $scope.websiteKey + 'json/' + $scope.thisPage + '.json', $dazzleUser.getDazzleInfo('$scope.this$scope.pageJson')).then(function () {
                        resolve();
                    });
                })
            }
                ...
                if ($scope.pageJson.indexOf(pagename) < 0) {
                    ...
                    $dazzleS3.getFile("dazzle-template", "file6.0/welcome.html").then(function (html) {
                        ...
                        Promise.all([
                            ...
                            $dazzleUser.setDazzleInfo('$scope.pageJson',$scope.pageJson);
...
//                            store.set('$scope.thisPage', pagename);
            ...
            $scope.codeManager = function () {
                ...
                $dazzlePopup.codeManagerPopup().then(function(result){
                    $dazzleS3.saveJson($scope.userBucket, $scope.websiteKey + 'json/' + $scope.thisPage + '.json', $scope.this$scope.pageJson);
                });
                ...
                //     }
                // }).then(function () {
                //     $scope.saveJson($scope.userBucket, $scope.websiteKey + 'json/' + $scope.thisPage + '.json', $scope.this$scope.pageJson);
                // });
            }
