...
app.directive('kpleeSuntaVideos', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaVideos = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "kpleeSuntaVideos";
            scope.type = "kpleeSuntaVideos";
