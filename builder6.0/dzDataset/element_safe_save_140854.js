            ...
            $scope.updateAngularTemplate = function(data) {
                ...
                template.find('[dz-field]').each(function(){
                    ...
                    switch(type){
                        ...
                        case 'youtube':
                            var embed = `
                            <iframe width="100%" height="auto" src="https://www.youtube.com/embed/JFuxtn6A3QA" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        `;
                            $(this).html(embed);
                            break;
