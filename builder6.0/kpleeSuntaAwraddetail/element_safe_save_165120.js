...
app.directive('kpleeSuntaAwarddetail', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaAwarddetail = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "kpleeSuntaAwarddetail";
            scope.type = "kpleeSuntaAwarddetail";
