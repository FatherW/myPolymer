...
app.directive('metalImageGalleryPopup', function ($compile, $templateRequest, $mdDialog, $dazzleUser,$dazzleS3,$dazzlePopup) {
    var link = {
        restrict: 'E',
        scope: true,
        templateUrl: "//d27btag9kamoke.cloudfront.net/builder6.0/metalImageGalleryPopup/element.html?id=" + new Date().getTime(),
...
//                $scope.tags = $scope.tags.push($scope.owner);
                ...
                $scope.getFileUrl = function (size, id) {
                    ...
                    return $scope.getFileUrl(size,id);
...
//                    $mdDialog.hide(element);
                ...
                $scope.newUpload = function() {
                    ...
                    var params = {
                        'name': 'metalUploadImagePopup',
                        'directive':'<metal-upload-image-popup></metal-upload-image-popup>',
                        'uid':uid,
                        'owner':$scope.owner
                    }
