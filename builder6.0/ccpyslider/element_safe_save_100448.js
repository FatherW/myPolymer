...
app.directive('ccpyslider', function ($compile, $templateRequest) {
    ...
    var ccpyslider = {
        ...
        controller: function ($scope, $element, $attrs) {
            ...
            $templateRequest("https://s3-ap-southeast-1.amazonaws.com/dazzle-template/builder6.0/ccpyslider/html/1490666058446.html" + "?id" + new Date().getTime()).then(function (html) {
