...
app.directive('dataPopup', function ($compile, $templateRequest, $mdDialog, $uibModal) {
    var name = 'dataPopup';
    var link = {
        restrict: 'E',
        scope: true,
        templateUrl: "https://d25k6mzsu7mq5l.cloudfront.net/builder6.0/dataPopup/element.html?id=" + new Date().getTime(),
        link: function (scope, element, attrs) {
            scope.http = "https://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "dataPopup";
            scope.type = "dataPopup";
