...
app.directive('editorContainer', function ($compile) {
    var editorContainer = {
        restrict: 'E',
        scope: true,
        template: '<div contenteditable="true" editable bind-html-compile="model.html | to_trusted" ng-model="model.html"></div>',
        controller: function ($scope, $element, $attrs) {
            ...
            $scope.contentChanged = function () {
                console.log('editorContainer contentChanged by editable');
            }
        }
    };
