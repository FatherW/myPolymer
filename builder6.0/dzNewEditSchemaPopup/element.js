console.log('dzNewEditSchemaPopup');
var app = angular.module('demoApp');
app.directive('dzNewEditSchemaPopup', function ($compile, $templateRequest, $mdDialog, $dazzlePopup) {
    var name = 'dzNewEditSchemaPopup';
    var link = {
        restrict: 'E',
        scope: true,
        ...
        controller: function ($scope, $element, $attrs,$dazzleS3, $http, $mdDialog, $mdSidenav, $mdBottomSheet,$dazzleUser,$ocLazyLoad) {
                ...
                console.log(params);
                console.log('dzNewEditSchemaPopupController');
