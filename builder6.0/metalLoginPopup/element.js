...
app.directive('metalLoginPopup', function ($http, $compile, $templateRequest, $interval, $mdDialog, $mdToast,$dazzleUser, $dazzleS3, $dazzlePopup, $ocLazyLoad) {
    var name = 'metalLoginPopup';
    var link = {
        restrict: 'E',
        scope:  true,
        templateUrl: "https://d27btag9kamoke.cloudfront.net/builder6.0/metalLoginPopup/element.html?id=" + new Date().getTime(),
        ...
        if (!$scope.loginJson.username) {
            ...
            $http({
                ...
                if (result.data.code > 0) {
                    ...
                    //setTimeout(function(){
                    $compile($('metal-user-header'))($scope);
