...
app.directive('getQuestion', function ($compile, $templateRequest, $mdDialog, $uibModal) {
    var getQuestion = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            ...
            scope.directiveId = "getQuestion";
            scope.type = "getQuestion";
        ...
        controller: function ($scope, $element, $attrs) {
            $scope.menuOptions = [
                ["getQuestion", function () {
                    console.log("Menu Clicked:getQuestion");
                }]/*,
                 ["更換模版", function () {
                 $mdDialog.show({
