...
app.directive('kpleeSuntaSharedetail', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaSharedetail = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "kpleeSuntaSharedetail";
            scope.type = "kpleeSuntaSharedetail";
