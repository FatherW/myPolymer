...
(function( $ ) {
  $(function() {
        app.directive('metalFrontCompanyBlock', function ($ocLazyLoad,$compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData, $dazzleUser, $dazzlePopup,$dazzleInit) {
