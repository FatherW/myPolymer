            ...
            $scope.menuOptions = [
                ...
                ['JS/Css 管理', function ($itemScope) {
                    var modalInstance = $uibModal.open({
                        ...
                        backdrop: 'static',
                        size: 'lg',
                        templateUrl: 'models/aceEditorPopup/popup.html' + "?id=" + new Date().getTime(),
                        controller: 'aceEditorInstanceCtrl',
                        resolve: {
                            code: function () {
                                return code || null;
                            },
                    ...
                    modalInstance.result.then(function (newCode) {
                        resovle(newCode);
                    });
                }]
            ];
