            ...
            $scope.menuOptions = [
                ...
                ['JS/Css 管理', function () {
                    $scope.openPageJsCssPopup($scope.thisPageJson).then(function (newThisPageJson) {
                        ...
                        console.log($scope.userBucket, $scope.websiteKey + '/json/' + $scope.thisPage + '.json', newThisPageJson);
                        $scope.saveJson($scope.userBucket, $scope.websiteKey + '/json/' + $scope.thisPage + '.json', newThisPageJson).then(function (result) {
                            console.log(result);
                        });
                    });
                }]
