...
app.directive('kpleeSuntaTestimonials', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaTestimonials = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "kpleeSuntaTestimonials";
            scope.type = "kpleeSuntaTestimonials";
        ...
        controller: function ($scope, $element, $attrs) {
             $scope.menuOptions = [
                ["員工感言管理", function () {
                    $scope.dataMng("testimonials");
                }],
                ["優閒小品管理", function () {
                    $scope.dataMng("sharing");
                }],
                ["推廣空間", function () {
                    $scope.dataMng("promotion");
                }],
                ["最新消息", function () {
                    $scope.dataMng("events");
                }]
                ];
