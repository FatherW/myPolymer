    ...
    var custom = {
        ...
        link: function (scope, elm, attrs) {
            ...
            function mouseover(target) {
                $(target).append('<i id="removeButtonHandle" class="fa fa-2x fa-window-close-o" onclick="angular.element(this).scope().removeAtom()"></i>');
            }
            ...
            setTimeout(function () {
                $(elm).append('<i id="removeButtonHandle" class="fa fa-2x fa-window-close-o" onclick="angular.element(this).scope().removeAtom()"></i>');
            }, 1000);
        }
    };
    return custom;
