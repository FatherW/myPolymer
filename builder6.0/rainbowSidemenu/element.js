...
app.directive('rainbowSidemenu', function ($compile, $templateRequest, $uibModal) {
    var path = "https://d25k6mzsu7mq5l.cloudfront.net/";
    var key = "builder6.0/rainbowSidemenu/html/id-1490793545305.html";
    var ccpymenu = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        ...
        controller: function ($scope, $element, $attrs) {
            console.log('ccpy sidemenu init start');
            ...
            $scope.getRealHtml = function () {
                $templateRequest("https://s3-ap-southeast-1.amazonaws.com/dazzle-template/builder6.0/rainbowSidemenu/html/template.html" + "?id=" + new Date().getTime()).then(function (html) {
                    var template = angular.element(html);
                    $compile(template)($scope);
                    setTimeout(function () {
