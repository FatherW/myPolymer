...
app.directive('editorContainerElement', function ($compile, $dazzlePopup, $templateRequest, $uibModal, $mdDialog) {
        ...
        controller: function ($scope, $element, $attrs) {
            $scope.menuOptions = [
                ['編緝Container', function () {
                    ...
                    $dazzlePopup.code(container.html(), 'html').then(function (newCode) {
