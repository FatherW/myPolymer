...
app.directive('editorHeader', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3, $dazzlePopup,$dazzleUser) {
    var editorHeader = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        templateUrl: "//d27btag9kamoke.cloudfront.net/builder6.0/editorHeader/element.html?id=" + new Date().getTime(),
