...
app.directive('deafData', function ($compile, $templateRequest, $mdDialog, $uibModal, $dazzlePopup,$dazzleUser,$dazzleInit) {
    var deafData = {
        restrict: 'E',
        priority: 1000,
        scope: true,
