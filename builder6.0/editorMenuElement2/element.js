...
app.directive('editorMenuElement', function ($compile, $templateRequest, $mdDialog, $uibModal) {
    var editorMenuElement = {
        ...
        controller: function ($scope, $element, $attrs) {
            $scope.menuOptions = [
                ["editorMenuElement", function () {
                    console.log("Menu Clicked:editorMenuElement");
                }]/*,
                 ["更換模版", function () {
                 $mdDialog.show({
