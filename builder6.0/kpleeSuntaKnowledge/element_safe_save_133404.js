...
app.directive('kpleeSuntaKnowledge', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaKnowledge = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d27btag9kamoke.cloudfront.net/";
            scope.directiveId = "kpleeSuntaKnowledge";
            scope.type = "kpleeSuntaKnowledge";
