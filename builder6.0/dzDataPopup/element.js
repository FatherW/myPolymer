...
console.log(window);
app.directive("dzDataPopup", function ($compile, $templateRequest, $mdDialog, $uibModal,$dazzleUser,$dazzleS3,dbElastic,$dazzlePopup,$dazzleFn,$dazzleInit,$dazzleData,dzS3,userInfo,pageInfo,dbElastic) {
    var link = {
        restrict: 'E',
        scope: true,
...
//            $scope.moment = moment;
            ...
            $scope.init = function () {
                ...
                //   dbElastic.dzInitGrid($scope.table).then(function(){
                    ...
                    var tableName = $scope.table;
                     dbElastic.tableName = $scope.table;
