...
app.directive(name, function ($compile, $templateRequest, $mdDialog, $uibModal,$dazzleUser,$dazzleS3,$dazzleElastic,$dazzlePopup,$dazzleFn,$dazzleInit,$dazzleData,dzS3,userInfo,pageInfo) {
    var link = {
        restrict: 'E',
        scope: true,
