...
app.directive('paging', function () {
    ...
    function build(scope, attrs) {
        ...
        app.directive('metalMyCompany', function ($compile, $timeout,  $mdDialog, $mdToast, $dazzleS3,$dazzleUser, $dazzlePopup) {
            ...
            var metalMyCompany = {
                ...
                controller: function ($scope, $http, $element) {
                  ...
                  $scope.isSearch = function(item) {
                      if (!$scope.keyword)
                        return true;
                      else {
                          if (item['title'].indexOf($scope.keyword)>=0)
                              return true;
                          else if (item['body'].indexOf($scope.keyword)>=0)
                              return true;
                          else
                            return false;                          
                      }
