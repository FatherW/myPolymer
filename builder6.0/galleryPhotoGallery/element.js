...
(function( $ ) {
  $(function() {
        app.directive('galleryPhotoGallery', function ($compile, $timeout, $uibModal, $mdDialog, $mdToast, $dazzleS3,$dazzleData, $dazzleUser, $dazzlePopup,$dazzleInit) {
            ...
            var galleryPhotoGallery = {
                restrict: 'E',
                priority: 1000,
                scope: true,
                templateUrl: "//d25k6mzsu7mq5l.cloudfront.net/builder6.0/galleryPhotoGallery/element.html?id=" + new Date().getTime(),
