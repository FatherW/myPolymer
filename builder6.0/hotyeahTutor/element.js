...
app.directive('hotyeahTutor', function ($compile, $templateRequest, $mdDialog, $uibModal,$dazzleInit,$dazzlePopup,$dazzleData,$dazzleUser,$dazzleFn) {
    ...
    var link = {
        restrict: 'EA',
        scope: true,
        templateUrl: "http://d25k6mzsu7mq5l.cloudfront.net/builder6.0/hotyeahTutor/element.html?id=" + new Date().getTime(),
...
//                $event.currentTarget.parent().remove();
            ...
            $scope.saveData = function() {
                ...
                //console.log(newList);  
                /*
                var newList = $('.lister-list').clone();
                newList.find('.lister-item-delete').remove();
