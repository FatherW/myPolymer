...
//                $event.currentTarget.parent().remove();
            ...
            $scope.saveData = function() {
                 ...
                 var oldList = $('.lister-list').html();
                console.log('oldlist',oldList);
                var sid = $("#dazzle-key").text();
                //console.log(sid);
                //console.log(newList);  
                ...
                var elem = $(oldList);
                 ...
                 elem.find('<div class="lister-item-delete" style="float:right;" ng-click="deleteTutor($event)">X</div>').replaceWith('<div class="lister-item-delete1" style="float:right;" ng-click="deleteTutor($event)">X</div>');

                //Read outerHTML property and update your variable or create new variable
                var newList = elem.prop("outerHTML");
                
                $(".lister-item-delete1").remove();
