                                ...
                                thisquery = thisdb;
                                 ...
                                 $http({
                                    ...
                                    if (result.data.code < 0) {
                                        ...
                                        for (var a=0; a<result.daa.resolve.length; a++) {
                                            console.log(result.data.resolve[a]);
                                        }
                                        $scope.model.datas = result.data.resolve;
                                        if (!$scope.model.datas)
                                            $scope.isNoData = true;
                                        console.log('Data: ',$scope.model.datas[0]);
                                        /*    
                                        $templateRequest(scope.templateUrl).then(function(html){
                                            scope.model.html = html;
                                            console.log('Template',html);
