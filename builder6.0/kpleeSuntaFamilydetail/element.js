...
app.directive('kpleeSuntaFamilydetail', function ($compile, $templateRequest,$mdDialog) {
    var kpleeSuntaFamilydetail = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        link: function (scope, element, attrs) {
            scope.http = "http://d25k6mzsu7mq5l.cloudfront.net/";
            scope.directiveId = "kpleeSuntaFamilydetail";
            scope.type = "kpleeSuntaFamilydetail";
