            ...
            scope.editorCustomInit(scope, element, attrs).then(function () {
              ...
              if (!angular.isUndefined(scope.model.db)){
                    ...
                    $dazzleData.getAtomData(scope.model.db).then(function(ids){
                        ...
                        $dazzleData.loadElasticRecordByIds(scope.model.db.index,scope.model.db.referTable,scope.model.keys).then(function(data){
                               scope.model.data = data;    
                              console.log('Init Course',$scope.model.data);                   
                               scope.useTemplate();
