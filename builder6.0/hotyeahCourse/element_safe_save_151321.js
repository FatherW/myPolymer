    ...
    var link = {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.editorCustomInit(scope, element, attrs).then(function () {
               ...
               $dazzleFn.dataInitByType(scope.model.db).then(function(value){
                   scope.model.data = value.data;
                   scope.model.value = value.ids;
                   console.log('IDS',scope.model.value);
                   scope.useTemplate();
                },function(err){
                    scope.model.data = [];
                    scope.model.value = [];
        ...
        controller: function ($scope, $element, $attrs,$dazzleS3, $http, $mdDialog, $mdSidenav, $mdBottomSheet,$dazzleUser) {
            ...
            $scope.remove = function(id){
                ...
                $dazzleData.loadElasticRecordByIds($scope.model.db.index,$scope.model.db.table,$scope.model.value).then(function(data){
                       $scope.model.data = data;    
                       $scope.useTemplate();
                });
            }
