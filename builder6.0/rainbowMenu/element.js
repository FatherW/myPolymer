...
app.directive('rainbowMenu', function ($compile, $templateRequest, $uibModal) {
    ...
    var ccpymenu = {
        ...
        controller: function ($scope, $element, $attrs) {
            ...
            $scope.getRealHtml = function () {
                $templateRequest("https://s3-ap-southeast-1.amazonaws.com/dazzle-template/builder6.0/rainbowMenu/html/template.html" + "?id" + new Date().getTime()).then(function (html) {
                    var template = angular.element(html);
                    $compile(template)($scope);
                    setTimeout(function () {
