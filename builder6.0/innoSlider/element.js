...
app.directive('innoSlider', function ($compile, $templateRequest, $mdDialog, $dazzlePopup,dzFn,atomInfo) {
    var dzSlider = {
        restrict: 'E',
        priority: 1000,
        scope: true,
        templateUrl: _cdn+"builder6.0/innoSlider/element.html?id=" + new Date().getTime(),
        css: {
          href: "//d27btag9kamoke.cloudfront.net/builder6.0/innoSlider/element.css?id=" + new Date().getTime(),
        ...
        link: function ($scope, element, attrs) {
            ...
            console.log('atom',atomInfo.atom);
