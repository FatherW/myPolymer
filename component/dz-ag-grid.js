...
customElements.define('dz-ag-grid',
class extends HTMLElement {
  constructor() {
    super();
      let that =this;
      let path = "https://d25k6mzsu7mq5l.cloudfront.net/agGrid/";
      // console.log('Component Path',fullpath);
      
        $.get(path+"head_js", function(head_js){          
          $.get(path+"html", function(html){       
            $.get(path+"body_js", function(body_js){         
              let head = document.createElement('dz-ag-grid-head');
              let dz_body = document.createElement('dz-body-js')
              ...
              dz_body.appendChild(elm);
              document.getElementsByTagName('body')[0].appendChild(dz_body);
