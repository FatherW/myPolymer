...
customElements.define('dz-editor2',
class extends HTMLElement {
  constructor() {
    ...
    // this.shadow = window['_shadow'];
    this.shadow = document.querySelector('dz-page').shadowRoot;
    ...
    //    console.log('Load Editor',this.inUse);
        ...
        let AnchorButton = MediumEditor.Extension.extend({
          ...
          handleClick: function (event) {
            ...
            let text;
            let selObj = document.querySelector('dz-page').getSelection(); 
            console.log(selObj);
