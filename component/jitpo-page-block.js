...
if (UrlExists(master_template+'body_js')) {
    getContent(master_template+'body_js').then(html=>{
      ...
      document.querySelector('dz-body').append(elm);
    });
}
else  
...
customElements.define('jitpo-page-block',
class extends HTMLElement {
  constructor() {
    super();
       const template = 'jitpo';
       const uid = 'jitpo';
      ...
      path = 'template/'+template+'/JITPO-PAGE-BLOCK/';
 ...
 //     const template = this.template;
      ...
      let key;
      let path = 'template/'+template+'/JITPO-PAGE-BLOCK/';
      if (master){
