...
customElements.define('hkdeaf-sidemenu',
class extends HTMLElement {
  constructor() {
    super();
      ...
      path = 'template/'+template+'/HKDEAF-SIDEMENU/'+id+'-menu.json';
      

      fullpath = path +"?id="+new Date().getTime();
      console.log('hkdeaf Path',fullpath);
      this.innerHTML = `
          <ul class="menu">
       ...
       .then(function(html) {
         console.log('deaf',html);
          ...
          json.forEach(item=>{
              ...
              a.innerHTML = item;
              li.appendChild(a);
              that.querySelector('ul.menu').appendChild(li);
          });
      }); 
