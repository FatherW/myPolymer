define(['dazzle', 'store', 'moment','domready','hotkeys'], function (dazzle, store,moment,hotkeys) {
    ...
    $(document).ready(function (e) {
        ...
        <editor-header id="editor-header"></editor-header>
...
//... end
    ...
    app.controller('editorController', function ($scope, $http, $element, $compile, $templateRequest, $interval, $mdDialog, $uibModal, $dazzleUser, $dazzleS3, $dazzlePopup, $ocLazyLoad,hotkeys) {
