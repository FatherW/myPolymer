...
//        'adobe-creative': 'https://cdn-creativesdk.adobe.io/v1/csdk',
...
//    loadCss("https://dazzle-template.s3.amazonaws.com/cdn6.0/css/angular-material-1.1.4.min.css");
    ...
    loadJs("https://cdn-creativesdk.adobe.io/v1/csdk.js");
    console.log('Init Adobe Createive SDK');

    /* 1) Initialize the AdobeCreativeSDK object */
    AdobeCreativeSDK.init({
        /* 2) Add your Client ID (API Key) */
        clientID: '13fbfe50aa2145759cd789d46097261b',
