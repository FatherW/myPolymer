...
//window.calendarConfig = calendarConfig;
		...
		'ngMaterialSidemenu','angularMoment','md.time.picker']);
...
//      var dzCalendar = angular.module("mwl.calendar",['dazzle'])
	...
	*/			
    ...
    // })
        ...
        dazzle.service('$dazzleUser', function ($http, $location,$interval,$ocLazyLoad,$mdDialog) {
            var that = this;
        ...
        dazzle.service('$dazzleInit',function($dazzleUser,$location, $dazzleS3,$http, $compile, $templateRequest, $interval, $mdDialog, $uibModal,$dazzlePopup, $ocLazyLoad){
            var scope = this;
