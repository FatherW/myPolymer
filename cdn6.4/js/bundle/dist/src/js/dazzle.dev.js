...
define(
    ['jquery', 'angular', 'aws-sdk', 'store', 'ace', 'aviary', 'medium-editor', 'ag-grid-enterprise', 'alasql', 'xlsx', 'moment', 'jquery-ui', 'bootstrap', 'slick', 'angular-animate', 'angular-aria', 'angular-route', 'angular-messages', 'angular-ui-bootstrap', 'angular-ui-sortable', 'angular-ui-ace', 'angular-ui-tree', 'angular-material', 'angular-material-timepicker', 'angular-material-fileinput',
        'angular-slick', 'angular-grid','angular-bootstrap-calendar', 'ocLazyLoad', 'angular-contextMenu', 'multirange-slider', 'angular-moment', 'hotkeys', 'adobe-creative',
        'angular-material-sidemenu'],

    function ($, angular, AWS, store, ace,  Aviary, MediumEditor, agGrid, alasql, xlsx, moment, hotkeys,AdobeCreativeSDK) {
...
//                                store.set('thispage', 'index');
            ...
            scope.loadAtom = function () {
                ...
                console.log('My Dazzle Info',$dazzleUser.dazzleInfo);
