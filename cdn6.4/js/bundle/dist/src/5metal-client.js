...
//    loadCss("https://dazzle-template.s3.amazonaws.com/cdn6.0/css/bootstrap-3.3.7.min.css");
  ...
  $(document).ready(function (e) {
    ...
    $('body').append(`
        <hotyeah-editor-header id="editor-header"></hotyeah-editor-header>           
        `);
...
//... end
    ...
    app.controller('5metalController', function ($scope, $http, $element, $compile, $templateRequest, $interval, $mdDialog,  $dazzleUser, $dazzleInit, $dazzleS3, $dazzlePopup, $ocLazyLoad) {
...
//           });
        ...
        $scope.init = function () {
            ...
            $scope.inited = false;
                console.log('Hello');
                $ocLazyLoad.load(['https://dazzle-template.s3.amazonaws.com/builder6.0/dzServiceDazzlePopup/element.js', 
                    'https://dazzle-template.s3.amazonaws.com/builder6.0/dzServiceDazzleData/element.js',
                    'https://dazzle-template.s3.amazonaws.com/builder6.0/dzServiceDazzleFn/element.js'], {cache: false}).then(function () {
