...
//    loadCss("https://dazzle-template.s3.amazonaws.com/cdn6.0/css/builder-index.css");
    ...
    loadScript("https://d27btag9kamoke.cloudfront.net/cdn6.0/js/store-2.0.12.min.js",function(){
    	...
    	if (editMode!="normal")
			loadScript("https://dazzle-template.s3.amazonaws.com/cdn6.4/js/bundle.6.5.3.min.js",function(){
//			loadScript("https://dazzle-template.s3.amazonaws.com/cdn6.4/js/dazzle-client.bundle.6.5.2.min.js",function(){
				loadJs("https://dazzle-template.s3.amazonaws.com/cdn6.4/js/dazzleAdminFactory.6.5.3.js");		
			});
        else
