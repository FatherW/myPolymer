...
define(['jquery'],function($) {
    ...
    if(!google_maps_loaded_def) {
        ...
        require(['http://maps.googleapis.com/maps/api/js?sensor=true&key=AIzaSyAN_dIE_33pcsdRWaRqx-EnJWNTNzOfqQI&callback=google_maps_loaded'],function(){},function(err) {
